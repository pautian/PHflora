...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($photo)) {
        // insert sql geninfo
        $sql = "INSERT INTO geninfo (`plant_id`, `scientific_name`, `common_name`, `p_order`, `family`, `pdescription`, `photo_id`) 
        VALUES (NULL, '$scientificname', '$commonname', '$order', '$family', '$description', NULL)";
        mysqli_query($conn, $sql);
    } else {
        // insert sql photo
        $sql = "INSERT INTO pictures (`photo_id`, `photo`, `title`, `caption`, `photographer`, `publisher`, `date_taken`)
    ...
    $sql = "SELECT plant_id FROM geninfo ORDER BY plant_id DESC limit 1";
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    ...
    VALUES (NULL, '$currentplant', '$contributor', '$newcontribution_date')";
    mysqli_query($conn, $sql);
    ...
    if (isset($_POST['ilocos'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '1')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['cagayanvalley'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', 2)";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['centralluzon'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '3')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['calabarzon'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '4')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['bicolregion'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '5')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['westernvisayas'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '6')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['centralvisayas'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '7')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['easternvisayas'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '8')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['zamboangapeninsula'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '9')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['northernmindanao'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '10')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['davaoregion'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '11')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['soccskargen'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '12')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['ncr'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '13')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['car'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '14')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['caraga'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '16')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['str'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '17')";
        mysqli_query($conn, $sql);
    }

    if (isset($_POST['barmm'])) {
        $sql = "INSERT INTO habitat (`plant_id`, `place_id`) VALUES ('$currentplant', '19')";
        mysqli_query($conn, $sql);
    }
