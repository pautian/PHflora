...
<div class="table-form">
    <div class="container-fluid mt-2">
        ...
        <!-- Selecting Records from the database -->
                    ...
                    <?php
                        include "dbconn.php";
                        $query = "SELECT * FROM geninfo_submitted g LEFT JOIN pictures p ON g.photo_id=p.photo_id";
                    ...
                    <div class="card-body">
                        ...
                        <?php
                            ...
                            $query = "SELECT p.photo_id as photo_id, photo, title, caption, photographer, publisher, date_taken
                                FROM geninfo_submitted G JOIN pictures P ON g.photo_id=p.photo_id
                        ...
                        <?php
                            ...
                            FROM geninfo_submitted G JOIN habitat_submitted H ON G.plant_id=H.plant_id
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <?php
                                    ...
                                    FROM geninfo_submitted g LEFT JOIN contribution_submitted c ON g.plant_id=c.plant_id LEFT JOIN contrib_references_submitted r ON c.contribution_id=r.contribution_id
                                    WHERE g.plant_id=$currplant_id;");
